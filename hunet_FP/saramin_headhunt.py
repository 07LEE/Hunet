...
url = 'https://www.saramin.co.kr/zf_user/jobs/list/headhunting?company_cd=10&cat_mcls=16&panel_type=domestic&search_optional_item=n&search_done=y&panel_count=y'
driver.get(url)
time.sleep(2)
...
while True :
    ...
    for content in content :
        ...
        data_notice_ = content.find('p', 'deadlines').find('span', 'reg_date').text
        data_notice_1 = re.sub('[^0-9]', '', data_notice_)
        data_notice_ = today - datetime.timedelta(days=int(data_notice_1))
