...
for key, value in dic_category.items():
    categorys = key
    cgname = value
    url = 'https://www.saramin.co.kr/zf_user/jobs/list/headhunting?company_cd=10&cat_mcls=%s&panel_type=domestic&search_optional_item=n&search_done=y&panel_count=y' % categorys
    driver.get(url)
    time.sleep(2)
